...
from photonix.photos.edit_tag import addTags
...
class PhotoTag(UUIDModel, VersionedModel):
    ...
    def save(self, *args, **kwargs):
        #logger.info("Calling photo tag save!")
        #logger.info(type(self.photo.base_image_path).__name__)
        #logger.info(type(self.tag.name).__name__)
        addTags([self.tag.name], self.photo.base_image_path)
        super(PhotoTag, self).save()
